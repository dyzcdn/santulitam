    ...
    <div class="relative mt-12 w-full max-w-lg sm:mt-10">
        ...
        <div
            ...
            <div class="flex flex-col p-6">
                <h3 class="text-xl font-semibold leading-6 tracking-tighter">Download ID Card SAKARITAM</h3>
                <p class="mt-1.5 text-sm font-medium text-white/50">
                    Silahkan masukkan informasi terkait untuk mendownload ID Card SAKARITAM
                </p>
            </div>
            <div class="p-6 pt-0">
                <form action="{{ route('download-idcard.download') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
                        <div>
                            <div

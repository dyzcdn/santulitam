        ...
        <div
            ...
            <div class="flex flex-col p-6">
                ...
                <p class="mt-1.5 text-sm font-medium text-white/50">
                    Hallo #KsatriaPetir, silahkan isi formulir untuk pendataan SAKARITAM.
                </p>
            </div>
            <div class="p-6 pt-0">
                <form action="{{ route('pendataan-peserta-karisma.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <div>
                            <div
                    ...
                    <div class="mt-4">
                        <div>
                            <div
                                ...
                                <div class="flex items-center">
                                    <input type="text" name="phone" placeholder="081234567890" autocomplete="on" required
                                        class="block w-full border-0 bg-transparent p-0 text-sm file:my-1 placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 focus:ring-teal-500 sm:leading-7 text-foreground">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        <div>
                            <div class="group relative rounded-lg border focus-within:border-sky-200 px-3 pb-1.5 pt-2.5 duration-200 focus-within:ring focus-within:ring-sky-300/30">
                                <div class="flex justify-between">
                                    <label class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Upload Pas Foto 4*6</label>
                                </div>
                                <div class="flex items-center">

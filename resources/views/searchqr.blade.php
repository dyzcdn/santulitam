    ...
    <div class="relative mt-12 w-full max-w-lg sm:mt-10">
        ...
        <div
            ...
            <div class="flex flex-col p-6">
                <h3 class="text-xl font-semibold leading-6 tracking-tighter">Download QR SAKARITAM</h3>
                <p class="mt-1.5 text-sm font-medium text-white/50">
                    Silahkan masukkan informasi terkait untuk mendownload QR SAKARITAM
                </p>
            </div>
            <div class="p-6 pt-0">
                <form action="{{ route('download-qr.download') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
                        <div>
                            <div
